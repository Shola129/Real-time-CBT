...
class InsertData{
    ...
    private $table3 = Platform::ADMINS_TABLE;
    ...
    public function process(){
        ...
        if($decodeMig2["status"]==="success"){
            ...
            $dob=$this->dto->dob;
            $phone=$this->dto->phone;   
            $org_code = $this->dto->organization_code;
    ...
    //     // check for org code if available
    //     $org_code = [
    //         "orgnization_code"=>$this->dto->orgnization_code
    //     ];

    //     $newMig1 = new Migration(null, $this->table3);
    //     $mig1 = $newMig1->get($org_code, 0, 1);
    //     $decodeMig1 = json_decode($mig1, true);
    //     if($decodeMig1["status"]==="success"){
    ...
    //         return json_encode([
    //             'status'=>'fail',
    //             'response'=>'no orgnization found  or available with the code submitted'
    //         ], JSON_PRETTY_PRINT);
    //         exit();
    //     }
